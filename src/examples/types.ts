export interface Example {
   ...
   * and either plain JavaScript or block syntax (see `dslToJs`). `SANDBOX`
   * is what the editor puts in scope. Keep lines under 55 columns for
   * readability; `npm run check:layout` enforces it.
   */
  code: string
}
